		...
		<div className="flex flex-wrap">
            ...
            RealEstify
					...
					<p className="mt-2 mb-4 text-gray-600 dark:text-gray-400 text-sm">
						RealEstify is a website that helps you find the best property for you.
					</p>
			...
			<div className="flex w-full md:w-2/12 px-4">
				<div className="flex flex-wrap items-top">
					<div className="w-full  ml-auto">
						<p className="font-bold text-2xl text-gray-900 dark:text-gray-100">Sitemap</p>
		...
		<div className="flex flex-wrap items-center md:justify-between justify-center">
			<div className="w-full md:w-4/12 px-4 mx-auto text-center">
				<div className="text-sm text-gray-600 dark:text-gray-400 py-1">
					...
					<a href="#" className="hover:underline hover:text-gray-900"> Developer</a>
				</div>
			</div>
		</div>
	</div>
